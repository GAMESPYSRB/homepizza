...
class Lafka_Order_Hours_Admin {
	...
	public function admin_init() {
		...
		$timezones_options = array_combine( $timezones, $timezones );
		add_settings_field(
	...
	public function lafka_order_hours_time_zone_cb( $args ) {
        ...
        <p>
            <span class="lafka-order-hours-current-time <?php echo Lafka_Order_Hours::get_shop_status()->code ?>">
                <?php esc_html_e( 'Current time', 'lafka-plugin' ); ?>: <?php echo date( 'H:i' ); ?> <?php esc_html_e( 'Status', 'lafka-plugin' ); ?>: <?php echo strtoupper( Lafka_Order_Hours::get_shop_status()->value ); ?>
            </span>
        </p>
		<?php
	}
