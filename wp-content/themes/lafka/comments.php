...
<div id="comments">
	<?php if (have_comments()) : ?>
		<h3 class="heading-title">
			<?php
			printf(_n('%1$s thought on %2$s', '%1$s thoughts on %2$s', get_comments_number(), 'lafka'), '<span class="lafka_comments_count">' . number_format_i18n(get_comments_number()) . '</span>', '<span>' . get_the_title() . '</span>');
			?>
		</h3>
